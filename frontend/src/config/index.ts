...
export const config = {
  ...
  ui: {
    ...
    progressSteps: [
      ...
      { id: 3, label: "Esperti", description: "Identificazione autorità per coalizione", icon: "Users", whyDescription: "Selezioniamo i parlamentari con maggiore autorità sul tema per ciascuna coalizione, in modo da garantire una rappresentazione bilanciata tra maggioranza e opposizione nella risposta finale." },
      { id: 4, label: "Interventi", description: "Recupero interventi rilevanti", icon: "MessageSquare", whyDescription: "Recuperiamo gli interventi parlamentari più rilevanti dal database vettoriale. Questi sono i discorsi reali tenuti in aula o in commissione, che formeranno la base documentale della risposta." },
      ...
      { id: 6, label: "Bussola Ideologica", description: "Analisi di posizionamento politico", icon: "Compass", whyDescription: "Analizziamo il posizionamento ideologico dei gruppi parlamentari sul tema specifico, mappando le posizioni su assi come libertà economica, diritti civili e integrazione europea." },
