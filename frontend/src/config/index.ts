...
export const config = {
  ...
  ui: {
    ...
    progressSteps: [
      ...
      { id: 8, label: "Salvataggio", description: "Completamento e verifica finale", icon: "CheckCircle2", whyDescription: "Completiamo la verifica finale della risposta, validando le citazioni e salvando il risultato in cronologia per consultazioni future." },
    ],
  },
