...
export const config = {
  ...
  ui: {
    ...
    progressSteps: [
      ...
      { id: 4, label: "Interventi", description: "Recupero interventi rilevanti", icon: "MessageSquare", whyDescription: "Recuperiamo gli interventi parlamentari più rilevanti dal database vettoriale. Questi sono i discorsi reali tenuti in aula che formeranno la base documentale della risposta." },
