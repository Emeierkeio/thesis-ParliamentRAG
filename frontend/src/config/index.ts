...
export const config = {
  ...
  ui: {
    ...
    progressSteps: [
      ...
      { id: 8, label: "Baseline", description: "Preparazione risposta di confronto per valutazione A/B" },
      { id: 9, label: "Valutazione", description: "Completamento e verifica finale" },
    ],
  },
